...
async function cargarCandidatosGuardados() {
    ...
    contenedorCandidatosGuardados.innerHTML = ""; // Limpiar el contenedor antes de mostrar los candidatos
...
btnGuardarCandidato.addEventListener('click', async function(){
    ...
    mensajeGuardado.textContent = resultado.mensaje; // Limpiar mensaje previo
    ...
    cargarCandidatosGuardados(); // Actualizar la lista de candidatos guardados
